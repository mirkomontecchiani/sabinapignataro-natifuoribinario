        ...
        <header class="nfb-header" id="nfb-header">
            <div class="nfb-header-inner">
                <div class="nfb-header-left">
                    <img src="<?php echo esc_url($cover_image); ?>" alt="<?php echo esc_attr($site_title); ?>" class="nfb-cover-image" style="width:auto!important;height:65px!important;max-height:65px!important;object-fit:contain!important;">
